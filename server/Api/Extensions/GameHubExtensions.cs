...
public static class GameHubExtensions
{
    ...
    public static async Task SendGameTableStateAsync(this IHubContext<GameHub> hubContext, GameTable table)
    {
        ...
        await hubContext.Clients.Group(table.GameName)
            .SendAsync("ReceiveCardOnTableCount", gameState.CardsOnTableCount);
    ...
    public static async Task SendEndGameTableAsync(this IHubContext<GameHub> hubContext, GameTable table)
    {
        ...
        await hubContext.Clients.Group(table.GameName)
            .SendAsync("RecieveEndGame", $"GameModels with name {table.GameName} end");
    }
}