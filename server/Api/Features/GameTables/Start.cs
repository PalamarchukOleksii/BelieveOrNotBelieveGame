...
public static class Start
{
        ...
        IGameTableService gameTableService)
    {
        ...
        if (result)
        {
            await hubContext.Clients.Group(request.GameName).SendAsync("RecieveGameStarted", "GameModels started");
        ...
        {
            await hubContext.Clients.Group(request.GameName)
                .SendAsync("RecieveGameNotStarted", "Waiting for other players to start the game");
        }
